...
class SaveUploadTest extends FileManagedTestBase {
  ...
  public function testSanitization() {
    ...
    $this->drupalPostForm('admin/config/media/file-system', $options, 'Save configuration');
    $this->drupalLogin($this->account);
    ...
    $message = t('Your upload has been renamed to') . ' <em class="placeholder">TEXT-oe.txt</em>';
    ...
    // Make sure we got a message about the rename.
    $message = t('Your upload has been renamed to') . ' <em class="placeholder">s-pace-tab-2.txt</em>';
    $this->assertSession()->responseContains($message);
  }
