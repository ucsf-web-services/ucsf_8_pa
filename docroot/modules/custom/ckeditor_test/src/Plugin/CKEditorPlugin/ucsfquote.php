...
class ucsfquote extends CKEditorPluginBase {
  ...
  public function getFile() {
    return drupal_get_path('module', 'ckeditor_test') . '/js/plugins/ucsfquote/plugin.js';
  }
  ...
  public function getButtons() {
    return [
      'ucsfquote' => [
        'label' => t('ucsfquote'),
        'image' => drupal_get_path('module', 'ckeditor_test') . '/js/plugins/ucsfquote/icons/ucsfquote.png',
      ]
    ];
  }
   /**
