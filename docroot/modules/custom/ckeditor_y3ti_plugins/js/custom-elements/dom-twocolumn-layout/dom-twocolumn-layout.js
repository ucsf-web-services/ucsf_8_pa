class DomTwoColumnLayout extends HTMLElement {
    constructor() {
      super();
    ...
    connectedCallback() {
        this.dataset.column1Size = this.dataset.column1Size || '50';
        this.dataset.column2Size = this.dataset.column2Size || '50';
    ...
    static get observedAttributes() {
      return ['data-column1-size', 'data-column2-size', 'data-column1-color', 'data-column2-color'];
    }
  ...
  customElements.define('dom-twocolumn-layout', DomTwoColumnLayout);