...
class DomOnecolumn extends CKEditorPluginBase implements CKEditorPluginConfigurableInterface {
  ...
  public function getFile() {
    return drupal_get_path('module', 'ckeditor_y3ti_plugins') . '/js/plugins/domonecolumn/plugin.js';
  }
  ...
  public function getButtons() {
    return [
      'Domonecolumn' => [
        ...
        'image' => drupal_get_path('module', 'ckeditor_y3ti_plugins') . '/js/plugins/domonecolumn/icons/domonecolumn.png',
      ]
    ];
  }
  /**
