...
CKEDITOR.plugins.add('blankdiv', {
  ...
  init: function(editor) {
    ...
    editor.widgets.add('blankdiv', {
      ...
      init: function() {
        if ( this.element.hasClass( 'align--center' ) ) this.setData( 'align', 'center' );
        if ( this.element.hasClass( 'align--left' ) ) this.setData( 'align', 'left' );
        if ( this.element.hasClass( 'align--right' ) ) this.setData( 'align', 'right' );
        if ( this.element.hasClass( 'size--full' ) ) this.setData( 'size', 'full' );
        if ( this.element.hasClass( 'size--half' ) ) this.setData( 'size', 'half' );
        if ( this.element.hasClass( 'size--twofifth' ) ) this.setData( 'size', 'twofifth' );
        if ( this.element.hasClass( 'size--third' ) ) this.setData( 'size', 'third' );
      ...
      data: function() {
        ...
        if ( this.data.align ) this.element.addClass( 'align--' + this.data.align );
        ...
        if ( this.data.size ) this.element.addClass( 'size--' + this.data.size );
