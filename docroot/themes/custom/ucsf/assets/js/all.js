    ...
    Drupal.behaviors.fixExplorer = {
        attach: function attach(context, settings) {
            ...
            if (detectIE()) {
                ...
                $('.path-frontpage .skip-link').after('<div class="ie-message">' + 'Looks like you’re visiting us on Internet Explorer. For the best UCSF.edu experience, ' + 'please use Chrome or Firefox, or upgrade to the latest Microsoft browser.' + '</div>');
            }
