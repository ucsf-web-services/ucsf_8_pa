...
(function () {
  ...
  var excludeElements = ['.home-banner__image img', 'dom-twocolumn-layout .element-fade', 'dom-threecolumn-layout .element-fade', '.column1 .element-fade', '.column2 .element-fade', '.column3 .element-fade', '.field-taxonomy-banner-image .element-fade', '.paragraph--type--gallery  :not(.slick-active) .element-fade', '.topics-list__topics img'];
