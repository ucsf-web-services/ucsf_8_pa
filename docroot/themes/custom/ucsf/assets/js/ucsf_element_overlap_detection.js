...
(function ($) {
  ...
  $(function () {
    ...
    var selectors = ['.half-image-left-full', '.half-image-left', '.full-bleed-image', '.callout-left', '.callout-left .callout__image', '.layout-columns__1', '.layout-columns__2', '.layout-columns__3', '.layout-columns__4', '.blockquote-full-width', '.blockquote--half-left', '.paragraph--type--gallery', '.align--left.wysiwyg_quote', '.scrolly-gallery'];
